...
public class FormChangePassword extends JDialog {
	...
	public FormChangePassword(User theUser, UserDAO theUserDAO) {
		this();
		user = theUser;
		userDAO = theUserDAO;
	...
	private void changePassword() {
		...
		if (!password.equals(confirmPassword)) {
			JOptionPane.showMessageDialog(FormChangePassword.this, "Passwords do not match.", "Error",
		...
		try {
			...
			dispose();
			JOptionPane.showMessageDialog(FormChangePassword.this, "Password updated successfully.", "Password Updated",
					JOptionPane.INFORMATION_MESSAGE);				
		}
		catch (Exception exc) {
			JOptionPane.showMessageDialog(FormChangePassword.this, "Error updating password.", "Error",
					JOptionPane.ERROR_MESSAGE);				
		}
	}
